    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form id="search" action="/admin/event/r/list" method="post">
                    ...
                    <table id="js_table" class="table table-bordered table-hover">
                        ...
                        <tbody>
                        <c:forEach var="event" varStatus="item" items="${page.data}">
                            <tr>
                                <td width="10%">${item.index + 1}</td>
                                <td width="20%"><a href="/admin/event/r/detail?id=${event.id}">${event.name}</a></td>
                                <td width="25%">${event.content}</td>
                                <td width="25%">${event.eventTime}</td>
                                <td width="20%">
                                </td>
                            </tr>
                        </c:forEach>
                ...
                <div class="box-footer clearfix">
                    <ez:page pageSize="${page.pageSize}" pageNum="${page.pageNum}"
                             total="${page.total}" uri="/admin/event/r/list"></ez:page>
                </div>
                <!-- /.box-footer -->
            </div>
        </div>
