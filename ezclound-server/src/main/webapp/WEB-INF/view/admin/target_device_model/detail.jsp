...
<section class="content">
    <div class="row">
        <div class="col-md-12">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="box-body">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <td>内部型号编码</td>
                                <td>${targetDeviceModel.model}</td>
                            </tr>
                            <tr>
                                <td>型号编码</td>
                                <td>${targetDeviceModel.longModel}</td>
                            </tr>
                            <tr>
                                <td>名称</td>
                                <td>${targetDeviceModel.name}</td>
                            </tr>
                            <tr>
                                <td>供应商</td>
                                <td>${targetDeviceModel.vendor}</td>
                            </tr>
                            <tr>
                                <td>说明</td>
                                <td>${targetDeviceModel.descr}</td>
                            </tr>
                            <tr>
                                <td>添加时间</td>
                                <td>${targetDeviceModel.createTime}</td>
                            </tr>
                            <tr>
                                <td>修改时间</td>
                                <td>${targetDeviceModel.updateTime}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">外设型号检查命令</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal">
